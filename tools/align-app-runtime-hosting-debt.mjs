...
const REPLACEMENTS = [
  ...
  ['self-hosted.unified-process.', 'standalone.unified-process.'],
  ['self-hosted.split-services.', 'standalone.split-services.'],
  ['cloud-hosted.unified-process.', 'cloud.unified-process.'],
  ['cloud-hosted.split-services.', 'cloud.split-services.'],
