...
const orderedReplacements = [
  ...
  ['sdkwork-api-cloud-gateway-api-server', 'sdkwork-api-cloud-gateway-api-server'],
  ['sdkwork-api-cloud-gateway-observability', 'sdkwork-api-cloud-gateway-observability'],
  ['sdkwork-api-cloud-gateway-registry', 'sdkwork-api-cloud-gateway-registry'],
  ['sdkwork-api-cloud-gateway-config', 'sdkwork-api-cloud-gateway-config'],
