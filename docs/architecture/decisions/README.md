...
Architecture decision records for `sdkwork-specs` follow `ARCHITECTURE_DECISION_SPEC.md`.
...
- [ADR-20260809 Platform Gateway Realtime Hosting](ADR-20260809-platform-gateway-realtime-hosting.md)
...
- [ADR-20260730 Repository Generated-State Boundary](ADR-20260730-repository-generated-state-boundary.md)
